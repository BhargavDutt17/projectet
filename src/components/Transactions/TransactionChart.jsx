...
const TransactionChart = () => {
  ...
  const tabs = [
    ...
    { title: "Income vs Expense Category", content: <Bar data={chartData(Object.keys(incomeBySub), Object.values(incomeBySub), "#4ade80", "#22c55e")} options={{ maintainAspectRatio: false }} /> },
    { title: "Expense by Category", content: <Bar data={chartData(Object.keys(expenseBySub), Object.values(expenseBySub), "#e50505", "#991b1b")} options={{ maintainAspectRatio: false }} /> },
    { title: "Income vs Expense", content: <Bar data={combinedIncomeExpenseData} options={{ maintainAspectRatio: false }} /> },
  ];
